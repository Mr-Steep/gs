    ...
    return (
        <>
            <aside
                ...
                aria-expanded="false">
                <div className="h-19">
                    <i className="sidenav-close absolute top-0 right-0 p-4 opacity-50 cursor-pointer fas fa-times dark:text-white text-slate-400 xl:hidden"></i>
                    <a className="block px-8 py-6 m-0 text-sm whitespace-nowrap dark:text-white text-slate-700"
                       ...
                       target="_blank">
                        ...
                        <img src="/img/logo-ct.png"
                             ...
                             alt="main_logo"/>
                        <span
                            className="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Global Stake</span>
                    </a>
                </div>
                        ...
                        <li className="mt-0.5 w-full">
                            <a className="py-2.7 bg-blue-500/13 dark:text-white dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors"
                               href="/dashboard">
                                ...
                                <span
                                    className="ml-1 duration-300 opacity-100 pointer-events-none ease">Dashboard</span>
                            </a>
                        </li>
                        ...
                        <li className="mt-0.5 w-full">
                            <a className=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                               href="/dashboard/about">
                                ...
                                <span className="ml-1 duration-300 opacity-100 pointer-events-none ease">About</span>
                            </a>
                        </li>
                        ...
                        <li className="mt-0.5 w-full">
                            <a className=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                               href="/dashboard/referral">
                                ...
                                <span
                                    className="ml-1 duration-300 opacity-100 pointer-events-none ease">Referral</span>
                            </a>
                        </li>
                ...
                <div className="mx-4">
                    ...
                    <div
                        className="sidenav-card relative flex flex-col min-w-0 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border"
                    >
                        <img className="w-1/2 mx-auto" src="/img/illustrations/icon-documentation.svg"
                        ...
                        <div className="flex-auto w-full p-4 pt-0 text-center">
                            <div className="transition-all duration-200 ease-nav-brand">
                                ...
                                <p className="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">Please
                                    check our docs</p>
                            </div>
                        </div>
                    </div>
